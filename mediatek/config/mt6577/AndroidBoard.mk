...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl \
                      ...
                      $(LOCAL_PATH)/save_kernel_log.sh:system/etc/save_kernel_log.sh \
                      $(LOCAL_PATH)/save_minios_kernel_log.sh:system/etc/save_minios_kernel_log.sh

# kyungmann.lee@lge.com 2012-07-11 add init.miniOS.rc for miniOS
PRODUCT_COPY_FILES += $(LOCAL_PATH)/init.miniOS.rc:root/init.miniOS.rc
...
##################################
#LGE_CHANGE_S : support for kernel.log in logger
include $(CLEAR_VARS)
LOCAL_MODULE       := save_kernel_log.sh
...
#LGE_CHANGE_S : support for kernel.log in logger
include $(CLEAR_VARS)
LOCAL_MODULE       := save_minios_kernel_log.sh
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := $(LOCAL_MODULE)
include $(BUILD_PREBUILT)
