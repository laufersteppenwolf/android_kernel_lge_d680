...
/*                                                                              */
            ...
            //if(DL1_Restart == KAL_TRUE)
            {
                ...
                //xlog_printk(ANDROID_LOG_INFO, "Sound", "AudDrv_write, HW_Read_idx=0x%x", HW_Read_idx); // disable log
...
/*                                                                              */
			...
			if(Afe_WriteIdx_tmp + copy_size < Afe_Block->u4BufferSize ) // copy once
         {
            ...
            {
			// add log for music speaker noise - dsable log
         ...
         else  // copy twice
         {
			...
			// add log for music speaker noise - disable log
