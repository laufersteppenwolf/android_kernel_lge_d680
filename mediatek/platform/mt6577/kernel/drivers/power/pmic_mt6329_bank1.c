...
/*                                                                                           */
#if defined(LGE_USE_COIN_MOTOR)   /* vibrator voltage (VIBR of MT6923 : 0x5(3.0V) */ /*                                 */
    ret=pmic_config_interface(BANK0_DIGLDO_CON33, 0x5, BANK_0_RG_VIBR_VOSEL_MASK, BANK_0_RG_VIBR_VOSEL_SHIFT);
#else   /* vibrator voltage (VIBR of MT6923 : 0x4(2.8V) */
