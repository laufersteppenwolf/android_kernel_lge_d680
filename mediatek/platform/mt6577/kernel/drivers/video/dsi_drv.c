...
//                                                                          
    if (FBMemVa)
    { 
        _m4u_lcdc_func.m4u_dealloc_mva(M4U_CLNTMOD_LCDC, FBMemVa, FBCommandSize, FBMemPhy);
        vfree((void *)FBMemVa);  
        FBMemVa = 0;
    }
//                                                                          
...
//                                                                          
			if (FBMemVa == 0)
			{
			    ...
			    {
			        DISP_LOG_PRINT(ANDROID_LOG_INFO, "DSI","[LCDC init M4U] M4U not been init for LCDC\n");
			    }
			    _m4u_lcdc_func.m4u_alloc_mva(M4U_CLNTMOD_LCDC, FBMemVa, FBCommandSize, &FBMemPhy);
            ...
            _m4u_lcdc_func.m4u_dma_cache_maint(M4U_CLNTMOD_LCDC, (void *)FBMemVa, FBCommandSize, DMA_BIDIRECTIONAL);      
