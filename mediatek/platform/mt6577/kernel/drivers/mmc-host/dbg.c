...
#define SDIO_AUTOTEST_CD 0xD
#ifndef USER_BUILD_KERNEL
static int mtk_sdio_proc_read(char *page, char **start, off_t off, int count, int *eof, void *data)
{
    char *p = page;
    int len = 0;
...
static int mtk_sdio_proc_write(struct file *file, const char *buf, unsigned long count, void *data)
{
	int ret;
