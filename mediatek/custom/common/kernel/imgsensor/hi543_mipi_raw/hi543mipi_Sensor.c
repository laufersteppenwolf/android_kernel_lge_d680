...
static void HI543MIPI_Init_setting(void)
{
	...
	HI543MIPI_write_cmos_sensor_8(0xe001,0x4a); //FOR SHUTTER//GAIN delay setting;must set //New setting for blink 20130119
	
	HI543MIPI_write_cmos_sensor_8(0xe0a1, 0x03); 
	HI543MIPI_write_cmos_sensor_8(0xe0a2, 0x80); 
	...
	HI543MIPI_write_cmos_sensor_8(0xe0a0, 0x04);
	...
	//                                                         
	HI543MIPI_write_cmos_sensor_8(0x0340, 0x07); // frame_length_lines_h  (= 1980 ) // New setting for blink 20130119
	HI543MIPI_write_cmos_sensor_8(0x0341, 0xBC); // frame_length_lines_l   
...
void HI543MIPI_Write_Shutter(kal_uint16 iShutter)
{
    ...
    if((HI543_CurrentScenarioId == MSDK_SCENARIO_ID_CAMERA_ZSD) || (HI543_CurrentScenarioId == MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG)) 
	{
	    ...
	    if((realtime_fp > 100)&&(realtime_fp <= 119))
	    {
		   SENSORDB("[autofliker realtime_fp=%d,extern heights slowdown to 10.0fps][height:%d]",realtime_fp,HI543MIPI_sensor.frame_length);
           realtime_fp =100; 
	    ...
	    else if((realtime_fp >= 120)&&(realtime_fp <= 125))
	    {
		   SENSORDB("[autofliker realtime_fp=%d,extern heights slowdown to 12.0fps][height:%d]",realtime_fp,HI543MIPI_sensor.frame_length);
           realtime_fp =120; 
		   HI543MIPI_sensor.frame_length = HI543MIPI_sensor.preview_vt_clk *10 / HI543MIPI_sensor.line_length / realtime_fp;
	    ...
	    else if((realtime_fp >= 126)&&(realtime_fp <= 145))
	    {
		   SENSORDB("[autofliker realtime_fp=%d,extern heights slowdown to 12.5fps][height:%d]",realtime_fp,HI543MIPI_sensor.frame_length);
           realtime_fp =126; 
		   HI543MIPI_sensor.frame_length = HI543MIPI_sensor.preview_vt_clk *10 / HI543MIPI_sensor.line_length / realtime_fp;
	    ...
	    else if((realtime_fp >= 146)&&(realtime_fp <= 153))
	    {
		   SENSORDB("[autofliker realtime_fp=%d,extern heights slowdown to 14.6fps][height:%d]",realtime_fp,HI543MIPI_sensor.frame_length);
           realtime_fp =146; 
		   HI543MIPI_sensor.frame_length = HI543MIPI_sensor.preview_vt_clk *10 / HI543MIPI_sensor.line_length / realtime_fp;
	    ...
	    else if((realtime_fp >= 154)&&(realtime_fp <= 193))
	    {
		   SENSORDB("[autofliker realtime_fp=%d,extern heights slowdown to 15.4fps][height:%d]",realtime_fp,HI543MIPI_sensor.frame_length);
           realtime_fp =154; 
		   HI543MIPI_sensor.frame_length = HI543MIPI_sensor.preview_vt_clk *10 / HI543MIPI_sensor.line_length / realtime_fp;
	    ...
	    else if((realtime_fp >= 194)&&(realtime_fp <= 219))
	    {
		   SENSORDB("[autofliker realtime_fp=%d,extern heights slowdown to 19.4fps][height:%d]",realtime_fp,HI543MIPI_sensor.frame_length);
           realtime_fp =194; 
		   HI543MIPI_sensor.frame_length = HI543MIPI_sensor.preview_vt_clk *10 / HI543MIPI_sensor.line_length / realtime_fp;
	    ...
	    else if((realtime_fp >= 220))
	    {
		   SENSORDB("[autofliker realtime_fp=%d,extern heights slowdown to 22.0fps][height:%d]",realtime_fp,HI543MIPI_sensor.frame_length);
           realtime_fp =220; 
		   HI543MIPI_sensor.frame_length = HI543MIPI_sensor.preview_vt_clk *10 / HI543MIPI_sensor.line_length / realtime_fp;
...
static void HI543MIPI_preview_setting(void)
{
	...
	HI543MIPI_write_cmos_sensor_8(0xe001,0x4a); //FOR SHUTTER//GAIN delay setting //New setting for blink 20130119

	HI543MIPI_write_cmos_sensor_8(0xe0a1, 0x03); //
	HI543MIPI_write_cmos_sensor_8(0xe0a2, 0x80); // BLC Dithering
	HI543MIPI_write_cmos_sensor_8(0xe0ae, 0x08); //
	...
	HI543MIPI_write_cmos_sensor_8(0xe05a, 0xbb);
	HI543MIPI_write_cmos_sensor_8(0xe05b, 0xcc);
	//HI543MIPI_write_cmos_sensor_8(0x0205, 0xC3);
	HI543MIPI_write_cmos_sensor_8(0xe0a0, 0x04);
	HI543MIPI_write_cmos_sensor_8(0xe0b4, 0x09);
	HI543MIPI_write_cmos_sensor_8(0xe0b5, 0x09);
	HI543MIPI_write_cmos_sensor_8(0xe0b6, 0x09);
	HI543MIPI_write_cmos_sensor_8(0xe0b7, 0x09);
	HI543MIPI_write_cmos_sensor_8(0xe0a2, 0x00);
	HI543MIPI_write_cmos_sensor_8(0x4050, 0x06);
	HI543MIPI_write_cmos_sensor_8(0x4055, 0x00);
	HI543MIPI_write_cmos_sensor_8(0x4056, 0x0a);
	...
	HI543MIPI_write_cmos_sensor_8(0x0009, 0x00); 
	HI543MIPI_write_cmos_sensor_8(0xE00D, 0x08); //PD Flushing for sub-sampling bit[3]='0' off, '1' enable.
	HI543MIPI_write_cmos_sensor_8(0x0900, 0x00);
	HI543MIPI_write_cmos_sensor_8(0x0901, 0x22);
...
{
	//full size setting revise@20130108
	HI543MIPI_write_cmos_sensor_8(0x0100, 0x00); 
	HI543MIPI_write_cmos_sensor_8(0x0100, 0x00); 
	HI543MIPI_write_cmos_sensor_8(0x0100, 0x00); 
	HI543MIPI_write_cmos_sensor_8(0x0103, 0x01); 
...
//		    HI543SetMaxFrameRate(234);
		    HI543SetMaxFrameRate(220);
                  SENSORDB("[HI543MIPISetAutoFlickerMode] frame rate(10base) = 220\n");
	    }
		else
	    {
            HI543SetMaxFrameRate(296);	       
...
{    
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_SET_ESHUTTER:
			//HI543MIPI_write_cmos_sensor_8(0x0104, 0x01);//hold para,hynix suggest @20130110,make sure set shutter first and then set gain // New setting for blink 20130119
        ...
        case SENSOR_FEATURE_SET_GAIN:
			...
			//HI543MIPI_write_cmos_sensor_8(0x0104, 0x00);//update para,hynix suggest @20130110 //New setting for blink 20130119
            break;
