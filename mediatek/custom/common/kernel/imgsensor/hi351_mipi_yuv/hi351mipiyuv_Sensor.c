...
MSDK_SCENARIO_ID_ENUM HI351CurrentScenarioId = ACDK_SCENARIO_ID_CAMERA_PREVIEW;

HI351_I2C_REG_STRUCT HI351_Initialize_Setting[2][6317] = {
//60Hz	
{
	{0x03, 0x00, BYTE_LEN},
...
//_CHANGE_E
	...
	{0x8f, 0x0f, BYTE_LEN},
#if 0 //                                                 
	{0x90, 0x0c, BYTE_LEN}, //BLC_TIME_TH_ON // STEVE for 50Hz
	{0x91, 0x0c, BYTE_LEN}, //BLC_TIME_TH_OFF // STEVE for 50Hz
#else
...
//_CHANGE_E
	...
	{0x12, 0x10, BYTE_LEN}, 		
	{0x19, 0x42, BURST_TYPE}, // band0 gain 40fps 0x2d
	{0x1a, 0x5c, BURST_TYPE}, // band1 gain 20fps original 34 Steve
	...
	{0x13, 0x11, BURST_TYPE}, //bCtl4_a00_n00
	...
	{0x46, 0x00, BURST_TYPE}, // steve H Outdoor Th (EV)
	{0x47, 0x0a, BURST_TYPE}, // steve M1 Outdoor Th (EV)
	           
	{0x48, 0xae, BURST_TYPE}, // steve M2 Outdoor Th (EV)
	{0x49, 0x60, BURST_TYPE}, // steve L Outdoor Th (EV)
	{0x4a, 0x00, BURST_TYPE},  // steve H outdoor -> indoor(EV) 
	{0x4b, 0x0c, BURST_TYPE},  // steve M1 outdoor -> indoor(EV)
	{0x4c, 0x35, BURST_TYPE},  // steve M2 outdoor -> indoor(EV)
	{0x4d, 0x00, BURST_TYPE},  // steve L outdoor -) indoor(EV) 
...
//AWB target angle
	...
	//AWB target RG angle                           
	{0xaa, 0x32, BYTE_LEN}, //aInRgTgtOfs_a00_n00
	{0xab, 0x28, BYTE_LEN}, //aInRgTgtOfs_a01_n00
	...
	//AWB target BG angle                           
	{0xb2, 0xb2, BYTE_LEN},//aInBgTgtOfs_a00_n00    
	{0xb3, 0xa8, BYTE_LEN}, //aInBgTgtOfs_a01_n00
...
// Y wgt
	...
	{0x59, 0x6e, BURST_TYPE}, // STEVE outdoor bluish
	{0x5a, 0x73, BURST_TYPE}, // STEVE outdoor bluish
	{0x5b, 0x78, BURST_TYPE}, // STEVE outdoor bluish
	{0x5c, 0x7d, BURST_TYPE}, // STEVE outdoor bluish
	{0x5d, 0x0a, BURST_TYPE},
	{0x5e, 0x05, BURST_TYPE},
	{0x5f, 0x00, BURST_TYPE},
	{0x60, 0x00, BURST_TYPE}, // STEVE outdoor bluish //aOutRgTgtOfs_a03_n00 
	{0x61, 0x00, BURST_TYPE}, // STEVE outdoor bluish //aOutRgTgtOfs_a04_n00
	{0x62, 0x00, BURST_TYPE}, // STEVE outdoor bluish //aOutRgTgtOfs_a05_n00
	{0x63, 0x8a, BURST_TYPE}, // STEVE outdoor bluish //aOutRgTgtOfs_a06_n00
	{0x64, 0x99, BURST_TYPE}, // STEVE outdoor bluish //aOutRgTgtOfs_a07_n00
	{0x65, 0x8a, BURST_TYPE},
	{0x66, 0x85, BURST_TYPE},
	{0x67, 0x00, BURST_TYPE},

	{0x68, 0x00, BURST_TYPE}, // STEVE outdoor bluish //aOutBgTgtOfs_a03_n00
	{0x69, 0x00, BURST_TYPE}, // STEVE outdoor bluish //aOutBgTgtOfs_a04_n00
	{0x6a, 0x00, BURST_TYPE}, // STEVE outdoor bluish //aOutBgTgtOfs_a05_n00
	{0x6b, 0x0a, BURST_TYPE}, // STEVE outdoor bluish //aOutBgTgtOfs_a06_n00
	{0x6c, 0x19, BURST_TYPE}, // aOutBgTgtOfs_a07_n00
	{0x6d, 0x00, BURST_TYPE},
	{0x6e, 0x00, BURST_TYPE},
	{0x6f, 0x00, BURST_TYPE},
...
// YLVL
	...
	{0xb9, 0x68, BURST_TYPE}, // STEVE outdoor bluish // steve OutRgainMin	
	{0xba, 0x88, BURST_TYPE}, // STEVE outdoor bluish // steve OutRgainMax	
	{0xbb, 0x4c, BURST_TYPE}, // STEVE outdoor bluish // steve OutBgainMin	
	{0xbc, 0x60, BURST_TYPE}, // STEVE outdoor bluish // steve OutBgainMax	
	...
	{0x23, 0x98, BURST_TYPE},  //CTEM high  9a -) 98
	{0x24, 0x57, BURST_TYPE},  //ctemp middler 50 -) 57
	{0x25, 0x45, BURST_TYPE},  //CTEM low 3e -) 45
	...
	{0x48, 0x32, BURST_TYPE},  //YLVL_09	 
	{0x49, 0x32, BURST_TYPE},  //YLVL_10	 
	{0x4a, 0x32, BURST_TYPE},  //36 YLVL_11
	...
	{0x57, 0x00, BURST_TYPE}, // No offset
	{0x58, 0x00, BURST_TYPE},
...
//_CHANGE_S MR LOW Light Tuning	           
	...
	{0x64, 0x04, BURST_TYPE},
	{0x65, 0x0A, BURST_TYPE},
	{0x66, 0x0F, BURST_TYPE},
	{0x67, 0x15, BURST_TYPE},
	{0x68, 0x21, BURST_TYPE},
	{0x69, 0x2E, BURST_TYPE},
	{0x6a, 0x3C, BURST_TYPE},
	{0x6b, 0x49, BURST_TYPE},
	{0x6c, 0x52, BURST_TYPE},
	{0x6d, 0x59, BURST_TYPE},
	{0x6e, 0x61, BURST_TYPE},
	{0x6f, 0x68, BURST_TYPE},
	{0x70, 0x6E, BURST_TYPE},
	{0x71, 0x74, BURST_TYPE},
	{0x72, 0x7A, BURST_TYPE},
	{0x73, 0x80, BURST_TYPE},
	{0x74, 0x86, BURST_TYPE},
	{0x75, 0x8B, BURST_TYPE},
	{0x76, 0x90, BURST_TYPE},
	{0x77, 0x95, BURST_TYPE},
	{0x78, 0x9F, BURST_TYPE},
	{0x79, 0xA7, BURST_TYPE},
	{0x7a, 0xB0, BURST_TYPE},
	{0x7b, 0xBE, BURST_TYPE},
	{0x7c, 0xCB, BURST_TYPE},
	{0x7d, 0xD5, BURST_TYPE},
	{0x7e, 0xDE, BURST_TYPE},
	...
	{0x86, 0x04, BURST_TYPE},
	{0x87, 0x0A, BURST_TYPE},
	{0x88, 0x0F, BURST_TYPE},
	{0x89, 0x15, BURST_TYPE},
	{0x8a, 0x21, BURST_TYPE},
	{0x8b, 0x2E, BURST_TYPE},
	{0x8c, 0x3C, BURST_TYPE},
	{0x8d, 0x49, BURST_TYPE},
	{0x8e, 0x52, BURST_TYPE},
	{0x8f, 0x59, BURST_TYPE},
	{0x90, 0x61, BURST_TYPE},
	{0x91, 0x68, BURST_TYPE},
	{0x92, 0x6E, BURST_TYPE},
	{0x93, 0x74, BURST_TYPE},
	{0x94, 0x7A, BURST_TYPE},
	{0x95, 0x80, BURST_TYPE},
	{0x96, 0x86, BURST_TYPE},
	{0x97, 0x8B, BURST_TYPE},
	{0x98, 0x90, BURST_TYPE},
	{0x99, 0x95, BURST_TYPE},
	{0x9a, 0x9F, BURST_TYPE},
	{0x9b, 0xA7, BURST_TYPE},
	{0x9c, 0xB0, BURST_TYPE},
	{0x9d, 0xBE, BURST_TYPE},
	{0x9e, 0xCB, BURST_TYPE},
	{0x9f, 0xD5, BURST_TYPE},
	{0xa0, 0xDE, BURST_TYPE},
	...
	{0xa8, 0x04, BURST_TYPE},
	{0xa9, 0x0A, BURST_TYPE},
	{0xaa, 0x0F, BURST_TYPE},
	{0xab, 0x15, BURST_TYPE},
	{0xac, 0x21, BURST_TYPE},
	{0xad, 0x2E, BURST_TYPE},
	{0xae, 0x3C, BURST_TYPE},
	{0xaf, 0x49, BURST_TYPE},
	{0xb0, 0x52, BURST_TYPE},
	{0xb1, 0x59, BURST_TYPE},
	{0xb2, 0x61, BURST_TYPE},
	{0xb3, 0x68, BURST_TYPE},
	{0xb4, 0x6E, BURST_TYPE},
	{0xb5, 0x74, BURST_TYPE},
	{0xb6, 0x7A, BURST_TYPE},
	{0xb7, 0x80, BURST_TYPE},
	{0xb8, 0x86, BURST_TYPE},
	{0xb9, 0x8B, BURST_TYPE},
	{0xba, 0x90, BURST_TYPE},
	{0xbb, 0x95, BURST_TYPE},
	{0xbc, 0x9F, BURST_TYPE},
	{0xbd, 0xA7, BURST_TYPE},
	{0xbe, 0xB0, BURST_TYPE},
	{0xbf, 0xBE, BURST_TYPE},
	{0xc0, 0xCB, BURST_TYPE},
	{0xc1, 0xD5, BURST_TYPE},
	{0xc2, 0xDE, BURST_TYPE},
  ...
  {0xea, 0xFF, BURST_TYPE},
	...
	{0x31, 0xa8, BURST_TYPE},//SATB_06
	{0x32, 0xa8, BURST_TYPE},//SATB_07
	{0x33, 0xa8, BURST_TYPE},//SATB_08
	{0x34, 0xb0, BURST_TYPE},//SATB_09
	{0x35, 0xb0, BURST_TYPE},//SATB_10
	{0x36, 0xb0, BURST_TYPE},//SATB_11 
	...
	{0x3d, 0xa8, BURST_TYPE},//SATR_06
	{0x3e, 0xa8, BURST_TYPE},//SATR_07
	{0x3f, 0xa8, BURST_TYPE},//SATR_08
	{0x40, 0xb0, BURST_TYPE},//SATR_09
	{0x41, 0xb0, BURST_TYPE},//SATR_10
	{0x42, 0xb0, BURST_TYPE},//SATR_11
...
//_CHANGE_S MR LOW Light Tuning
	...
	{0x1b, 0x68, BURST_TYPE}, //LSC 00 Gain GB
	{0x1c, 0x68, BURST_TYPE}, //LSC 00 Gain B
	{0x1d, 0x68, BURST_TYPE}, //LSC 00 Gain R
	{0x1e, 0x68, BURST_TYPE}, //LSC 00 Gain GR
	...
	{0x23, 0x68, BURST_TYPE}, //LSC 01 Gain GB
	{0x24, 0x68, BURST_TYPE}, //LSC 01 Gain B
	{0x25, 0x68, BURST_TYPE}, //LSC 01 Gain R
	{0x26, 0x68, BURST_TYPE}, //LSC 01 Gain GR
	...
	{0x2b, 0x68, BURST_TYPE}, //LSC 02 Gain GB
	{0x2c, 0x5E, BURST_TYPE}, //LSC 02 Gain B
	{0x2d, 0x82, BURST_TYPE}, //LSC 02 Gain R
	{0x2e, 0x68, BURST_TYPE}, //LSC 02 Gain GR
	...
	{0x44, 0x74, BURST_TYPE}, //LSC 05 Gain B
	...
	{0x5c, 0x74, BURST_TYPE}, //7c LSC 08 Gain B
	...
	{0x64, 0x88, BURST_TYPE}, //7c LSC 09 Gain B
	{0x65, 0x70, BURST_TYPE}, //80 LSC 09 Gain R
...
//_CHANGE_E ADD INTO MR ver. for low light condition
...
#if 0 //                                                 
	{0x10, 0xe9, BYTE_LEN}, // STEVE AE ON    (50hz : 0xe9, 60hz : 0xe1)
#else
	{0x10, 0xe1, BYTE_LEN},
	...
	///////////////////////////////////////////
	{0x03, 0xCD, BYTE_LEN},
	{0x10, 0x38, BYTE_LEN}, //ColorRatio disable Ω√≈¥
...
void HI351YUVSensorInitialSetting(void)
{
    ...
    UINT32 total_delay_ms = 0, setting_len = 0, error_cnt = 0;
    UINT8 burst_buff[255] = {0};
    UINT32 i=0, j=0;

	HI351_TRACE("[HI351]:hi351_antibanding = %d\n", hi351_antibanding);
	setting_len = sizeof(HI351_Initialize_Setting[hi351_antibanding]) / sizeof(HI351_Initialize_Setting[hi351_antibanding][0]);
    ...
    while (i < setting_len)
    {
        init_reg = &HI351_Initialize_Setting[hi351_antibanding][i];
    ...
    HI351_TRACE("[HI351] Done! Apply setting=%d, setting_len=%d, total delay=%d(ms), error_cnt=%d \n", \
                i, setting_len, total_delay_ms, error_cnt);
}
...
void HI351PreviewSetting(void)
{
    ...
    if(HI351_prev_gain != 0)
    {
		...
		HI351_write_cmos_sensor(0x3A, 0x11);
		HI351_write_cmos_sensor(0x3B, 0x11);
		HI351_write_cmos_sensor(0x3C, 0x11);
		HI351_write_cmos_sensor(0x3D, 0x11);
		HI351_write_cmos_sensor(0x3E, 0x11);
		HI351_write_cmos_sensor(0x3F, 0x11);
		HI351_write_cmos_sensor(0x40, 0x11);
		HI351_write_cmos_sensor(0x41, 0x11);
		HI351_write_cmos_sensor(0x42, 0x11);
		HI351_write_cmos_sensor(0x43, 0x11);
		HI351_write_cmos_sensor(0x44, 0x11);
		HI351_write_cmos_sensor(0x45, 0x11);
		HI351_write_cmos_sensor(0x46, 0x11);
		HI351_write_cmos_sensor(0x47, 0x11);
		HI351_write_cmos_sensor(0x48, 0x11);
		HI351_write_cmos_sensor(0x49, 0x11);
		HI351_write_cmos_sensor(0x4A, 0x11);
		HI351_write_cmos_sensor(0x4B, 0x11);
		HI351_write_cmos_sensor(0x4C, 0x11);
		HI351_write_cmos_sensor(0x4D, 0x21);
		HI351_write_cmos_sensor(0x4E, 0x44);
		HI351_write_cmos_sensor(0x4F, 0x44);
		HI351_write_cmos_sensor(0x50, 0x12);
		HI351_write_cmos_sensor(0x51, 0x11);
		HI351_write_cmos_sensor(0x52, 0x11);
		HI351_write_cmos_sensor(0x53, 0x22);
		HI351_write_cmos_sensor(0x54, 0x44);
		HI351_write_cmos_sensor(0x55, 0x44);
		HI351_write_cmos_sensor(0x56, 0x22);
		HI351_write_cmos_sensor(0x57, 0x11);
		HI351_write_cmos_sensor(0x58, 0x21);
		HI351_write_cmos_sensor(0x59, 0x44);
		HI351_write_cmos_sensor(0x5A, 0x44);
		HI351_write_cmos_sensor(0x5B, 0x44);
		HI351_write_cmos_sensor(0x5C, 0x44);
		HI351_write_cmos_sensor(0x5D, 0x12);
		HI351_write_cmos_sensor(0x5E, 0x21);
		HI351_write_cmos_sensor(0x5F, 0x44);
		HI351_write_cmos_sensor(0x60, 0x44);
		HI351_write_cmos_sensor(0x61, 0x44);
		HI351_write_cmos_sensor(0x62, 0x44);
		HI351_write_cmos_sensor(0x63, 0x12);
		HI351_write_cmos_sensor(0x64, 0x21);
		HI351_write_cmos_sensor(0x65, 0x44);
		HI351_write_cmos_sensor(0x66, 0x44);
		HI351_write_cmos_sensor(0x67, 0x44);
		HI351_write_cmos_sensor(0x68, 0x44);
		HI351_write_cmos_sensor(0x69, 0x12);
		HI351_write_cmos_sensor(0x6A, 0x11);
		HI351_write_cmos_sensor(0x6B, 0x11);
		HI351_write_cmos_sensor(0x6C, 0x11);
		HI351_write_cmos_sensor(0x6D, 0x11);
		HI351_write_cmos_sensor(0x6E, 0x11);
		HI351_write_cmos_sensor(0x6F, 0x11);

		HI351_write_cmos_sensor(0x03, 0x19); //Scaler Setting
		HI351_write_cmos_sensor(0x10, 0x87);
		HI351_write_cmos_sensor(0x20, 0x04); //ZOOM_DST_WIDTH_H	 
		HI351_write_cmos_sensor(0x21, 0x00); //ZOOM_DST_WIDTH_L	 
		HI351_write_cmos_sensor(0x22, 0x03); //ZOOM_DST_HEIGHT_H	 
		HI351_write_cmos_sensor(0x23, 0x00); //ZOOM_DST_HEIGHT_L	 
		HI351_write_cmos_sensor(0x24, 0x00); //ZOOM_WIN_STX_H 	 
		HI351_write_cmos_sensor(0x25, 0x03); //ZOOM_WIN_STX_L 	 STEVE00 value changed : 0x03 -) 0x01
		HI351_write_cmos_sensor(0x26, 0x00); //ZOOM_WIN_STY_H 	 
		HI351_write_cmos_sensor(0x27, 0x00); //ZOOM_WIN_STY_L 	 
		HI351_write_cmos_sensor(0x28, 0x04); //ZOOM_WIN_ENX_H 	 
		HI351_write_cmos_sensor(0x29, 0x03); //ZOOM_WIN_ENX_L 	 STEVE00 value changed : 0x83 -) 0x81
		HI351_write_cmos_sensor(0x2a, 0x03); //ZOOM_WIN_ENY_H 	 
		HI351_write_cmos_sensor(0x2b, 0x00); //ZOOM_WIN_ENY_L 	 
		HI351_write_cmos_sensor(0x2c, 0x08); //ZOOM_VER_STEP_H	 
		HI351_write_cmos_sensor(0x2d, 0x00); //ZOOM_VER_STEP_L	 
		HI351_write_cmos_sensor(0x2e, 0x08); //ZOOM_HOR_STEP_H	 
		HI351_write_cmos_sensor(0x2f, 0x00); //ZOOM_HOR_STEP_L	 
		HI351_write_cmos_sensor(0x30, 0x04); //ZOOM_FIFO_DELAY	 
		HI351_write_cmos_sensor(0x30, 0x04); //ZOOM_FIFO_DELAY	 
		HI351_write_cmos_sensor(0x03, 0x00);
		...
		HI351_write_cmos_sensor(0xf0, 0x0d); // STEVE Dark mode for Sawtooth

		HI351_write_cmos_sensor(0x03, 0xc4); //AE en

		HI351_write_cmos_sensor(0x10, 0xe9); // STEVE AE ON    (50hz : 0xe9, 60hz : 0xe1)
    ...
    if(HI351_prev_gain != 0)
    {
		...
		HI351_write_cmos_sensor(0x03, 0xc4); //AE en
		HI351_write_cmos_sensor(0x10, 0xe1); // STEVE AE ON    (50hz : 0xe9, 60hz : 0xe1)
...
void HI351FullPreviewSetting(void)
{
    ...
    HI351_write_cmos_sensor(0x03,0x11);           
    HI351_write_cmos_sensor(0xf0,0x00); //DMA Auto
...
void HI351CaptureSetting(void)
{
	if (hi351_antibanding == HI351_50HZ)
	{
		...
		HI351_write_cmos_sensor(0x25, 0x0a); // Xstart
		HI351_write_cmos_sensor(0x26, 0x00);
		HI351_write_cmos_sensor(0x27, 0x08); // Y start
		HI351_write_cmos_sensor(0x28, 0x08);
		HI351_write_cmos_sensor(0x29, 0x0a); // Xend
		HI351_write_cmos_sensor(0x2a, 0x06);
		HI351_write_cmos_sensor(0x2b, 0x08); // Y end
		HI351_write_cmos_sensor(0x2c, 0x08);
		HI351_write_cmos_sensor(0x2d, 0x00);
		HI351_write_cmos_sensor(0x2e, 0x08);
		HI351_write_cmos_sensor(0x2f, 0x00);
		HI351_write_cmos_sensor(0x30, 0x04);
		HI351_write_cmos_sensor(0x30, 0x04);
		HI351_write_cmos_sensor(0x03, 0x00);
		HI351_write_cmos_sensor(0x14, 0x20); // for Full mode
		HI351_write_cmos_sensor(0x10, 0x00); //Full
		...
		HI351_write_cmos_sensor(0x03, 0x11);
		HI351_write_cmos_sensor(0xf0, 0x00); // STEVE Dark mode for Sawtooth
...
BOOL HI351_set_param_wb(UINT16 para)
{
    ...
    switch (para)
    {
		...
		case AWB_MODE_AUTO:
			...
			HI351_write_cmos_sensor(0xb9, 0x68); // STEVE outdoor bluish //bOutRgainMin_a00_n00
			...
			HI351_write_cmos_sensor(0xbc, 0x60); // STEVE outdoor bluish //bOutBgainMax_a00_n00
			...
			HI351_write_cmos_sensor(0x31, 0xa8); //SATB_06
			HI351_write_cmos_sensor(0x32, 0xa8); //SATB_07
			HI351_write_cmos_sensor(0x33, 0xa8); //SATB_08
			HI351_write_cmos_sensor(0x34, 0xb0); //SATB_09
			HI351_write_cmos_sensor(0x35, 0xb0); //SATB_10
			HI351_write_cmos_sensor(0x36, 0xb0); //SATB_11
			...
			HI351_write_cmos_sensor(0x3d, 0xa8);//SATR_06
			HI351_write_cmos_sensor(0x3e, 0xa8);//SATR_07
			HI351_write_cmos_sensor(0x3f, 0xa8);//SATR_08
			HI351_write_cmos_sensor(0x40, 0xb0);//SATR_09
			HI351_write_cmos_sensor(0x41, 0xb0);//SATR_10
			HI351_write_cmos_sensor(0x42, 0xb0);//SATR_11
			mdelay(5);
			break;
...
BOOL HI351_set_param_iso(UINT16 para)
{
    ...
    case AE_ISO_400:
        HI351_write_cmos_sensor(0x03, 0xD5);				  
	    HI351_write_cmos_sensor(0x10, 0x46);
        break;
    default:
        HI351_write_cmos_sensor(0x03, 0xD5);				  
...
void hi351_scene_normal_mode(void) 
{
	if (hi351_antibanding == HI351_50HZ)
	{
		...
		//FPS Auto
		HI351_write_cmos_sensor(0x03, 0x20);
		HI351_write_cmos_sensor(0x24, 0x00); //EXP Max 8.33 fps (STEVE FOR 50Hz)
		HI351_write_cmos_sensor(0x25, 0x41);
		HI351_write_cmos_sensor(0x26, 0xe4);
		HI351_write_cmos_sensor(0x27, 0x40);
		...
		//WB Auto
		HI351_write_cmos_sensor(0x03, 0xc5); //Page 0xc5
		HI351_write_cmos_sensor(0x10, 0xb1); //STEVE AWB on
		...
		//Saturation 0
		HI351_write_cmos_sensor(0x03, 0xd1); //page D1(Adaptive)
		// Cb
		HI351_write_cmos_sensor(0x2b, 0x90); //SATB_00 STEVE for Low Light
		HI351_write_cmos_sensor(0x2c, 0x90); //SATB_01 STEVE for Low Light
		HI351_write_cmos_sensor(0x2d, 0x90); //SATB_02 STEVE for Low Light
		...
		HI351_write_cmos_sensor(0x1d, 0x20); //outdoor

		HI351_write_cmos_sensor(0x03, 0xdd);
		HI351_write_cmos_sensor(0x1d, 0x20); //indoor

		HI351_write_cmos_sensor(0x03, 0xe0);
		HI351_write_cmos_sensor(0x1d, 0x24); //dark1

		HI351_write_cmos_sensor(0x03, 0xe3);
		HI351_write_cmos_sensor(0x1d, 0x26); //dark2
	...
	else	// 60Hz == 0
	{
		...
		//FPS Auto
		HI351_write_cmos_sensor(0x03, 0x20);
		HI351_write_cmos_sensor(0x24, 0x00); //EXP Max 8.00 fps
		HI351_write_cmos_sensor(0x25, 0x44);
		HI351_write_cmos_sensor(0x26, 0xa3);
...
void hi351_scene_portrait_mode(void)
{
	if (hi351_antibanding == HI351_50HZ)
	{
		...
		HI351_write_cmos_sensor(0xb9, 0x58); //bOutRgainMin_a00_n00
		HI351_write_cmos_sensor(0xba, 0xf0); //bOutRgainMax_a00_n00
		HI351_write_cmos_sensor(0xbb, 0x40); //bOutBgainMin_a00_n00
		HI351_write_cmos_sensor(0xbc, 0x90); //bOutBgainMax_a00_n00
		...
		// STEVE SATB
		HI351_write_cmos_sensor(0x2b, 0x78);//SATB_00"
		HI351_write_cmos_sensor(0x2c, 0x78);//SATB_01"
		HI351_write_cmos_sensor(0x2d, 0x78);//SATB_02"
		HI351_write_cmos_sensor(0x2e, 0x80);//SATB_03"
		HI351_write_cmos_sensor(0x2f, 0x80);//SATB_04"
		HI351_write_cmos_sensor(0x30, 0x80);//SATB_05"
		HI351_write_cmos_sensor(0x31, 0x88);//SATB_06"
		HI351_write_cmos_sensor(0x32, 0x88);//SATB_07"
		HI351_write_cmos_sensor(0x33, 0x88);//SATB_08"
		HI351_write_cmos_sensor(0x34, 0x88);//SATB_09"
		HI351_write_cmos_sensor(0x35, 0x88);//SATB_10"
		HI351_write_cmos_sensor(0x36, 0x88);//SATB_11"

		// STEVE SATR
		HI351_write_cmos_sensor(0x37, 0x78);//SATR_00"
		HI351_write_cmos_sensor(0x38, 0x78);//SATR_01"
		HI351_write_cmos_sensor(0x39, 0x78);//SATR_02"
		HI351_write_cmos_sensor(0x3a, 0x80);//SATR_03"
		HI351_write_cmos_sensor(0x3b, 0x80);//SATR_04"
		HI351_write_cmos_sensor(0x3c, 0x80);//SATR_05"
		HI351_write_cmos_sensor(0x3d, 0x88);//SATR_06"
		HI351_write_cmos_sensor(0x3e, 0x88);//SATR_07"
		HI351_write_cmos_sensor(0x3f, 0x88);//SATR_08"
		HI351_write_cmos_sensor(0x40, 0x88);//SATR_09"
		HI351_write_cmos_sensor(0x41, 0x88);//SATR_10"
		HI351_write_cmos_sensor(0x42, 0x88);//SATR_11"

		//Sharpness -1
		HI351_write_cmos_sensor(0x03, 0xda);
		HI351_write_cmos_sensor(0x1d, 0x24);//outdoor

		HI351_write_cmos_sensor(0x03, 0xdd);
		HI351_write_cmos_sensor(0x1d, 0x24);//indoor

		HI351_write_cmos_sensor(0x03, 0xe0);
		HI351_write_cmos_sensor(0x1d, 0x26);//dark1
...
void hi351_scene_landscape_mode(void) 
{
	if (hi351_antibanding == HI351_50HZ)
	{
		...
		HI351_write_cmos_sensor(0x4B, 0x11);
		HI351_write_cmos_sensor(0x4C, 0x11);
		HI351_write_cmos_sensor(0x4D, 0x11);
		HI351_write_cmos_sensor(0x4E, 0x11);
		HI351_write_cmos_sensor(0x4F, 0x11);
		HI351_write_cmos_sensor(0x50, 0x11);
		HI351_write_cmos_sensor(0x51, 0x11);
		HI351_write_cmos_sensor(0x52, 0x11);
		HI351_write_cmos_sensor(0x53, 0x11);
		HI351_write_cmos_sensor(0x54, 0x11);
		HI351_write_cmos_sensor(0x55, 0x11);
		HI351_write_cmos_sensor(0x56, 0x11);
		HI351_write_cmos_sensor(0x57, 0x11);
		HI351_write_cmos_sensor(0x58, 0x11);
		HI351_write_cmos_sensor(0x59, 0x11);
		HI351_write_cmos_sensor(0x5A, 0x11);
		HI351_write_cmos_sensor(0x5B, 0x11);
		HI351_write_cmos_sensor(0x5C, 0x11);
		HI351_write_cmos_sensor(0x5D, 0x11);
		HI351_write_cmos_sensor(0x5E, 0x11);
		HI351_write_cmos_sensor(0x5F, 0x11);
		HI351_write_cmos_sensor(0x60, 0x11);
		HI351_write_cmos_sensor(0x61, 0x11);
		HI351_write_cmos_sensor(0x62, 0x11);
		HI351_write_cmos_sensor(0x63, 0x11);
		HI351_write_cmos_sensor(0x64, 0x11);
		HI351_write_cmos_sensor(0x65, 0x11);
		HI351_write_cmos_sensor(0x66, 0x11);
		HI351_write_cmos_sensor(0x67, 0x11);
		HI351_write_cmos_sensor(0x68, 0x11);
		HI351_write_cmos_sensor(0x69, 0x11);
		HI351_write_cmos_sensor(0x6A, 0x11);
		HI351_write_cmos_sensor(0x6B, 0x11);
		HI351_write_cmos_sensor(0x6C, 0x11);
		HI351_write_cmos_sensor(0x6D, 0x11);
		...
		//SATB
		HI351_write_cmos_sensor(0x2b, 0x80);//SATB_00"
		HI351_write_cmos_sensor(0x2c, 0x80);//SATB_01"
		HI351_write_cmos_sensor(0x2d, 0x80);//SATB_02"
		HI351_write_cmos_sensor(0x2e, 0xaa);//SATB_03"
		HI351_write_cmos_sensor(0x2f, 0xa4);//SATB_04"
		HI351_write_cmos_sensor(0x30, 0xa4);//SATB_05"
		HI351_write_cmos_sensor(0x31, 0xa8);//SATB_06"
		HI351_write_cmos_sensor(0x32, 0xa8);//SATB_07"
		HI351_write_cmos_sensor(0x33, 0xa8);//SATB_08"
		...
		//SATR
		HI351_write_cmos_sensor(0x37, 0x80);//SATR_00"
		HI351_write_cmos_sensor(0x38, 0x80);//SATR_01"
		HI351_write_cmos_sensor(0x39, 0x80);//SATR_02"
		HI351_write_cmos_sensor(0x3a, 0x9a);//SATR_03"
		HI351_write_cmos_sensor(0x3b, 0x98);//SATR_04"
		HI351_write_cmos_sensor(0x3c, 0x98);//SATR_05"
		HI351_write_cmos_sensor(0x3d, 0x9c);//SATR_06"
		HI351_write_cmos_sensor(0x3e, 0x9c);//SATR_07"
		HI351_write_cmos_sensor(0x3f, 0x9c);//SATR_08"
		HI351_write_cmos_sensor(0x40, 0x9c);//SATR_09"
		HI351_write_cmos_sensor(0x41, 0x9c);//SATR_10"
		HI351_write_cmos_sensor(0x42, 0x9c);//SATR_11"

		//Sharpness 1
		HI351_write_cmos_sensor(0x03, 0xda);
		HI351_write_cmos_sensor(0x1d, 0x1f);//outdoor

		HI351_write_cmos_sensor(0x03, 0xdd);
		HI351_write_cmos_sensor(0x1d, 0x1f);//indoor

		HI351_write_cmos_sensor(0x03, 0xe0);
		HI351_write_cmos_sensor(0x1d, 0x22);//dark1

		HI351_write_cmos_sensor(0x03, 0xe3);
		HI351_write_cmos_sensor(0x1d, 0x24);//dark2
...
void hi351_scene_sport_mode(void) 
{
	if (hi351_antibanding == HI351_50HZ)
	{
		...
		//FPS Sports
		HI351_write_cmos_sensor(0x03, 0x20);
		HI351_write_cmos_sensor(0x24, 0x00); //EXP Max 30.00 fps
		HI351_write_cmos_sensor(0x25, 0x15);
		HI351_write_cmos_sensor(0x26, 0xf6);
		...
		// STEVE SATB
		HI351_write_cmos_sensor(0x2b, 0x70);//SATB_00"
		HI351_write_cmos_sensor(0x2c, 0x70);//SATB_01"
		HI351_write_cmos_sensor(0x2d, 0x70);//SATB_02"
		HI351_write_cmos_sensor(0x2e, 0x80);//SATB_03"
		HI351_write_cmos_sensor(0x2f, 0x80);//SATB_04"
		HI351_write_cmos_sensor(0x30, 0x80);//SATB_05"
		HI351_write_cmos_sensor(0x31, 0x88);//SATB_06"
		...
		// STEVE SATR
		HI351_write_cmos_sensor(0x37, 0x70);//SATR_00"
		HI351_write_cmos_sensor(0x38, 0x70);//SATR_01"
		HI351_write_cmos_sensor(0x39, 0x70);//SATR_02"
		HI351_write_cmos_sensor(0x3a, 0x80);//SATR_03"
		HI351_write_cmos_sensor(0x3b, 0x80);//SATR_04"
		HI351_write_cmos_sensor(0x3c, 0x80);//SATR_05"
		HI351_write_cmos_sensor(0x3d, 0x88);//SATR_06"
	...
	else	// 60Hz == 0
	{
		...
		HI351_write_cmos_sensor(0x03, 0x20);
		HI351_write_cmos_sensor(0x24, 0x00); //EXP Max 30.00 fps
		HI351_write_cmos_sensor(0x25, 0x16);
		HI351_write_cmos_sensor(0x26, 0xE1);
		HI351_write_cmos_sensor(0x27, 0x08);
...
void hi351_scene_sunset_mode(void) 
{
	if (hi351_antibanding == HI351_50HZ)
	{
		...
		HI351_write_cmos_sensor(0x03, 0xc6);
		HI351_write_cmos_sensor(0x18, 0x59); //bInRgainMin
		HI351_write_cmos_sensor(0x19, 0x61); //bInRgainMax
		HI351_write_cmos_sensor(0x1a, 0x66); //bInBgainMin
		HI351_write_cmos_sensor(0x1b, 0x6e); //bInBgainMax

		HI351_write_cmos_sensor(0xb9, 0x59); //bOutRgainMin
		HI351_write_cmos_sensor(0xba, 0x61); //bOutRgainMax
		HI351_write_cmos_sensor(0xbb, 0x66); //bOutBgainMin
		HI351_write_cmos_sensor(0xbc, 0x6e); //bOutBgainMax


		//Saturation 0
		HI351_write_cmos_sensor(0x03, 0xd1); //page D1(Adaptive)
		// Cb
		HI351_write_cmos_sensor(0x2b, 0x98); //SATB_00 STEVE for Low Light
		HI351_write_cmos_sensor(0x2c, 0x98); //SATB_01 STEVE for Low Light
		HI351_write_cmos_sensor(0x2d, 0x98); //SATB_02 STEVE for Low Light
		HI351_write_cmos_sensor(0x2e, 0x98); //SATB_03
		HI351_write_cmos_sensor(0x2f, 0x98); //SATB_04
		HI351_write_cmos_sensor(0x30, 0x98); //SATB_05
		...
		// Cr
		HI351_write_cmos_sensor(0x37, 0x98); //SATR_00 STEVE for Low Light
		HI351_write_cmos_sensor(0x38, 0x98); //SATR_01 STEVE for Low Light
		HI351_write_cmos_sensor(0x39, 0xa0); //SATR_02 STEVE for Low Light
		HI351_write_cmos_sensor(0x3a, 0x98); //SATR_03
		HI351_write_cmos_sensor(0x3b, 0x98); //SATR_04
		HI351_write_cmos_sensor(0x3c, 0x98); //SATR_05
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    //HI351_set_ae_enable(HI351_AE_ENABLE);		// not need samjinjang
                    ...
                    MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->CaptureDelayFrame = Capture_delay_in_Flash; 
    ...
    pSensorInfo->MIPIDataLowPwr2HighSpeedSettleDelayCount = 15; // samjinjang mipi signal timing change for preview black patch 20130425
...
UINT32 HI351YUVSensorSetting(FEATURE_ID iCmd, UINT32 iPara)
{
    ...
    case FID_AE_SCENE_MODE: 
        if (ACDK_SCENARIO_ID_CAMERA_ZSD != HI351CurrentScenarioId)
        {
...
UINT32 HI351YUVSetVideoMode(UINT16 u2FrameRate)
{
	...
	u2FrameRate_temp = u2FrameRate / 1000;		//                                                         
    ...
    if (u2FrameRate == 30)
    {
		if (hi351_antibanding == HI351_50HZ)
		{
			...
			// CAMCODER MODE : 30 ~ 15FPS
			mdelay(20); // STEVE DELAY		  
			HI351_write_cmos_sensor(0x03, 0x00);
			HI351_write_cmos_sensor(0x01, 0xf1); //Sleep on
			...
			HI351_write_cmos_sensor(0x03, 0xe3); //  For Camcording Spatial LPF design parameters
			HI351_write_cmos_sensor(0xae, 0x03); // dark2
			HI351_write_cmos_sensor(0xaf, 0x14);
			HI351_write_cmos_sensor(0xb0, 0x10);
			HI351_write_cmos_sensor(0xb1, 0x27);
			HI351_write_cmos_sensor(0xb2, 0x11);
			HI351_write_cmos_sensor(0xb3, 0x0f);
			HI351_write_cmos_sensor(0xb4, 0x12);
			HI351_write_cmos_sensor(0xb5, 0x0f);
			HI351_write_cmos_sensor(0xb6, 0x13);
			HI351_write_cmos_sensor(0xb7, 0xa3);
			HI351_write_cmos_sensor(0xb8, 0x14);
			HI351_write_cmos_sensor(0xb9, 0x3c);
			HI351_write_cmos_sensor(0xba, 0x15);
			HI351_write_cmos_sensor(0xbb, 0x18);
			HI351_write_cmos_sensor(0xbc, 0x16);
			HI351_write_cmos_sensor(0xbd, 0x10);
			HI351_write_cmos_sensor(0xbe, 0x17);
			HI351_write_cmos_sensor(0xbf, 0x08);
			HI351_write_cmos_sensor(0xc0, 0x18);
			HI351_write_cmos_sensor(0xc1, 0x32);
			HI351_write_cmos_sensor(0xc2, 0x19);
			HI351_write_cmos_sensor(0xc3, 0x30);
			HI351_write_cmos_sensor(0xc4, 0x1a);
			HI351_write_cmos_sensor(0xc5, 0x30);
			HI351_write_cmos_sensor(0xc6, 0x20);
			HI351_write_cmos_sensor(0xc7, 0x80);

			HI351_write_cmos_sensor(0x03, 0x20); //Page 20
			HI351_write_cmos_sensor(0x24, 0x00); //EXP Max 16.67 fps (50Hz)
			HI351_write_cmos_sensor(0x25, 0x20); 
			HI351_write_cmos_sensor(0x26, 0xf2); 
			HI351_write_cmos_sensor(0x27, 0x20);
			HI351_write_cmos_sensor(0x28, 0x00); //EXPMin 25210.08 fps
			HI351_write_cmos_sensor(0x29, 0x0b);
			HI351_write_cmos_sensor(0x2a, 0x28);
			...
			HI351_write_cmos_sensor(0x03, 0x30);
			HI351_write_cmos_sensor(0x36, 0x28); //preview function

			mdelay(20); 


			HI351_write_cmos_sensor(0x03, 0x00);
			HI351_write_cmos_sensor(0x10, 0x13); // scale
			HI351_write_cmos_sensor(0x11, 0x83); //

			HI351_write_cmos_sensor(0x03, 0x18); //Page 18
			HI351_write_cmos_sensor(0xC4, 0x7e); //FLK200
			HI351_write_cmos_sensor(0xC5, 0x69); //FLK240

			HI351_write_cmos_sensor(0x03, 0x00); //PAGE 0
			HI351_write_cmos_sensor(0x90, 0x06); //BLC_TIME_TH_ON  // STEVE for 50hz
			HI351_write_cmos_sensor(0x91, 0x06); //BLC_TIME_TH_OFF // STEVE for 50hz
			HI351_write_cmos_sensor(0x92, 0xe8); //BLC_AG_TH_ON  //STEVE AGC OxD0
			HI351_write_cmos_sensor(0x93, 0xe0); //BLC_AG_TH_OFF //STEVE AGC OxD0

			//DCDC
			HI351_write_cmos_sensor(0x03, 0x02); //PAGE 2
			HI351_write_cmos_sensor(0xd4, 0x06); //DCDC_TIME_TH_ON	// STEVE for 50hz
			HI351_write_cmos_sensor(0xd5, 0x06); //DCDC_TIME_TH_OFF // STEVE for 50hz
			HI351_write_cmos_sensor(0xd6, 0xe8); //DCDC_AG_TH_ON
			HI351_write_cmos_sensor(0xd7, 0xe0); //DCDC_AG_TH_OFF

			HI351_write_cmos_sensor(0x03, 0xcf); // STEVE : EV max -> 94 b6 b4 [fixed frame : not enough int. time]
			HI351_write_cmos_sensor(0x13, 0x00); //Y_LUM_MAX 10fps, AG 0xA0
			HI351_write_cmos_sensor(0x14, 0xB0);
			HI351_write_cmos_sensor(0x15, 0x00);
			HI351_write_cmos_sensor(0x16, 0x00);
		...
		else		// 60hz == 0
		{
			...
			HI351_write_cmos_sensor(0x03, 0x20); //Page 20
			HI351_write_cmos_sensor(0x24, 0x00); //EXP Max 15.00 fps (60Hz)
			HI351_write_cmos_sensor(0x25, 0x24);
			HI351_write_cmos_sensor(0x26, 0x9b);
			HI351_write_cmos_sensor(0x27, 0x40);
			...
			HI351_write_cmos_sensor(0x03, 0x00); //PAGE 0
			HI351_write_cmos_sensor(0x90, 0x08); //BLC_TIME_TH_ON
			HI351_write_cmos_sensor(0x91, 0x08); //BLC_TIME_TH_OFF
			HI351_write_cmos_sensor(0x92, 0xe8); //BLC_AG_TH_ON  //STEVE AGC OxD0
			HI351_write_cmos_sensor(0x93, 0xe0); //BLC_AG_TH_OFF //STEVE AGC OxD0

			//DCDC
			HI351_write_cmos_sensor(0x03, 0x02); //PAGE 2
			HI351_write_cmos_sensor(0xd4, 0x08); //DCDC_TIME_TH_ON
			HI351_write_cmos_sensor(0xd5, 0x08); //DCDC_TIME_TH_OFF
			...
			HI351_write_cmos_sensor(0x10, 0xe1); // STEVE AE en
    ...
    {
		if (hi351_antibanding == HI351_50HZ)		// 50 hz == 1
		{
			// Fixed Framerate 15fps
			mdelay(20); // STEVE DELAY		  
			HI351_write_cmos_sensor(0x03, 0x00);
			HI351_write_cmos_sensor(0x01, 0xf1); //Sleep on
			...
			HI351_write_cmos_sensor(0x20, 0x00); //EXP Normal 33.33 fps (STEVE for 50Hz)
			HI351_write_cmos_sensor(0x21, 0x10);
			HI351_write_cmos_sensor(0x22, 0x79);
			HI351_write_cmos_sensor(0x23, 0x10);
			HI351_write_cmos_sensor(0x24, 0x00); //EXP Max 33.33 fps (STEVE for 50Hz)
			...
			HI351_write_cmos_sensor(0x03, 0x00);
			HI351_write_cmos_sensor(0x10, 0x13); // scale
			HI351_write_cmos_sensor(0x11, 0x87); //bit2 on
			...
			HI351_write_cmos_sensor(0x90, 0x03); //BLC_TIME_TH_ON  //STEVE for 50hz
			HI351_write_cmos_sensor(0x91, 0x03); //BLC_TIME_TH_OFF //STEVE for 50hz
			HI351_write_cmos_sensor(0x92, 0xe8); //BLC_AG_TH_ON    STEVE fixed AGC 0xD0
			HI351_write_cmos_sensor(0x93, 0xe0); //BLC_AG_TH_OFF   STEVE fixed AGC 0xD0

			//DCDC
			HI351_write_cmos_sensor(0x03, 0x02); //PAGE 2
			HI351_write_cmos_sensor(0xd4, 0x03); //DCDC_TIME_TH_ON	//STEVE for 50hz
			HI351_write_cmos_sensor(0xd5, 0x03); //DCDC_TIME_TH_OFF //STEVE for 50hz

			HI351_write_cmos_sensor(0xd6, 0xe8); //DCDC_AG_TH_ON
			HI351_write_cmos_sensor(0xd7, 0xe0); //DCDC_AG_TH_OFF

			HI351_write_cmos_sensor(0x03, 0xcf); // STEVE : EV max -> 76f890 [fixed frame : not enough int. time]
			HI351_write_cmos_sensor(0x13, 0x00); //Y_LUM_MAX 10fps, AG 0xA0
			HI351_write_cmos_sensor(0x14, 0x88);
			HI351_write_cmos_sensor(0x15, 0x00);
			HI351_write_cmos_sensor(0x16, 0x00);
		...
		{	
			...
			HI351_write_cmos_sensor(0x20, 0x00); //EXP Normal 30.00 fps
			HI351_write_cmos_sensor(0x21, 0x12);
			HI351_write_cmos_sensor(0x22, 0x4d);
			HI351_write_cmos_sensor(0x23, 0xa0);
			HI351_write_cmos_sensor(0x24, 0x00); //EXP Max 30.00 fps
			HI351_write_cmos_sensor(0x25, 0x12);
			HI351_write_cmos_sensor(0x26, 0x4d);
			HI351_write_cmos_sensor(0x27, 0xa0);
			...
			HI351_write_cmos_sensor(0x90, 0x04); //BLC_TIME_TH_ON  STEVE fixed
			HI351_write_cmos_sensor(0x91, 0x04); //BLC_TIME_TH_OFF STEVE fixed
			HI351_write_cmos_sensor(0x92, 0xe8); //BLC_AG_TH_ON    STEVE fixed AGC 0xD0
			HI351_write_cmos_sensor(0x93, 0xe0); //BLC_AG_TH_OFF   STEVE fixed AGC 0xD0

			//DCDC
			HI351_write_cmos_sensor(0x03, 0x02); //PAGE 2
			HI351_write_cmos_sensor(0xd4, 0x04); //DCDC_TIME_TH_ON
			HI351_write_cmos_sensor(0xd5, 0x04); //DCDC_TIME_TH_OFF
			...
			HI351_write_cmos_sensor(0x10, 0xe1); // STEVE AE ON
...
static void HI351GetExifInfo(UINT32 pSensorExifInfoStruct)
{
	...
	Info->RealISOValue = Exif_info.iso_auto; // should insert real ISO when ISO value is AUTO
