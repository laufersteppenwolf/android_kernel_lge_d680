...
#define HI351_FULL_PERIOD_PIXEL_NUMS    (2180+110)    /* Default full size line length */
#define HI351_FULL_PERIOD_LINE_NUMS     (1586+164)    /* Default full size frame length */

/* SENSOR PREVIEW SIZE & START GRAB PIXEL OFFSET */
#define IMAGE_SENSOR_PV_GRAB_START_X        (0)
#define IMAGE_SENSOR_PV_GRAB_START_Y        (1)
...
#define IMAGE_SENSOR_FULL_GRAB_START_Y      (1)
