...
kal_uint16 HI542MIPI_MAX_EXPOSURE_LINES = HI542MIPI_PV_PERIOD_LINE_NUMS;//980;
...
static void HI542MIPI_Sensor_Init(void)
{
	...
	HI542MIPI_write_cmos_sensor(0x03d4,0x18);     //         chengxue without
	mDELAY(10);
	///////////////////////////////////////////////////
	///////////////////////////////////////////////////
...
//                   fixed 15fps
	...
	HI542MIPI_write_cmos_sensor(0x0011, 0x00); //fixed frame setting turn off
...
void HI542MIPI_set_video15fps(void)
{
	...
	HI542MIPI_write_cmos_sensor(0x0013, 0x20);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    switch (ScenarioId)
    {
        ...
        case MSDK_SCENARIO_ID_CAMERA_CAPTURE_MEM:
            ...
            pSensorInfo->SensorPixelClockCount= 3;
            pSensorInfo->SensorDataLatchCount= 2;
            pSensorInfo->SensorGrabStartX = 11; 
...
UINT32 HI542MIPISetVideoMode(UINT16 u2FrameRate)
{
    ...
    else if (u2FrameRate == 15)       
    {
			...
			spin_lock(&hi542mipi_drv_lock);
			//HI542MIPI_MAX_EXPOSURE_LINES = 84000000/15/HI542MIPI_FULL_PERIOD_PIXEL_NUMS;
			//2147
