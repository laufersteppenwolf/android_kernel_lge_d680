...
/* sysfs  */
static DEVICE_ATTR(mem, 0664, ist30xx_mem_show, ist30xx_mem_store);
...
static DEVICE_ATTR(clb, 0664, ist30xx_calib_show, ist30xx_calib_store);
static DEVICE_ATTR(debug, 0664, NULL, ist30xx_debug_store);
static DEVICE_ATTR(tsp_power, 0664, NULL, ist30xx_power_store);
...
static DEVICE_ATTR(tunes_fw, 0664, NULL, tunes_fw_store);
static DEVICE_ATTR(tunes_param, 0664, NULL, tunes_param_store);
