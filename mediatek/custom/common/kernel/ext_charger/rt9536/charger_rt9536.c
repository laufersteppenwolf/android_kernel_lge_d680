...
void charging_ic_set_ta_mode()
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/Charger", "[charger_rt9536] :: charging_ic_set_ta_mode\n");
...
{
    xlog_printk(ANDROID_LOG_INFO, "Power/Charger", "[charger_rt9536] :: charging_ic_set_usb_mode\n");
...
void charging_ic_set_factory_mode()
{
    ...
    xlog_printk(ANDROID_LOG_INFO, "Power/Charger", "[charger_rt9536] :: charging_ic_set_factory_mode\n");
