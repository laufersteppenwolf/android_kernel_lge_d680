...
// 9487
   ...
   {0xe1, 15, {0x0f, 0x2d, 0x27, 0x0a, 0x0f, 0x09, 0x3f, 0x53, 0x2a, 0x09, 0x04, 0x03, 0x0d, 0x08, 0x00}}, // neg gamma
    ...
    {0xf7, 4, {0xa9, 0x51, 0x2C, 0x8a}}, // frame rate ctrl
...
//                                                                  
	...
	LCM_DEBUG("\n[seosctest]%s, get_driver_ic[%d] \n\n", __func__,get_driver_ic);
	if(lcm_read_IC_name() == 0x87)
		driver_ic_ili9487= 1;
	else
		driver_ic_ili9487=0;
	LCM_DEBUG("\n[seosctest]%s, driver_ic_ili9487[%d] \n\n", __func__,driver_ic_ili9487);
...
//	id = read_reg(0xF4);
	...
	LCM_DEBUG("\n\n\n\n\n\n[seosctest]%s, lcm_read = 0x%x\n\n\n\n\n", __func__, id);
	LCM_DEBUG("\n\n\n\n\n\n[seosctest]%s, lcm_read 0= 0x%x\n\n\n\n\n", __func__,  buffer[0]);
	LCM_DEBUG("\n\n\n\n\n\n[seosctest]%s, lcm_read 1= 0x%x\n\n\n\n\n", __func__,  buffer[1]);
	LCM_DEBUG("\n\n\n\n\n\n[seosctest]%s, lcm_read 2= 0x%x\n\n\n\n\n", __func__,  buffer[2]);
	LCM_DEBUG("\n\n\n\n\n\n[seosctest]%s, lcm_read 3= 0x%x\n\n\n\n\n", __func__,  buffer[3]);
...
LCM_DRIVER ili9487_hvga_lcm_drv = 
{
    .name			= "ili9487_hvga_dsi_vdo",
