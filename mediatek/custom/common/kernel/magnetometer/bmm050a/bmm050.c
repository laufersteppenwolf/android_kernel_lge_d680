...
#if defined(FEATURE_LGE_V5_HW_REVA)
#define BMM050_I2C_ADDRESS                 0x10
#else
#define BMM050_I2C_ADDRESS                 0x11
#endif
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_init(struct bmc050 *p_bmc050);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_flipdataX(
		BMC050_S16 *mdata_x);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_flipdataY(
		BMC050_S16 *mdata_y);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_halldataZ(
		BMC050_S16 *mdata_z);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_raw_xyz(
		struct bmm050api_mdata *mdata);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_raw_xyzr(
		struct bmm050api_mdata *mdata);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_read_mdataXYZ(
		struct bmm050api_mdata *mdata);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_read_mdataX(
		BMC050_S16 *mdata_x);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_read_mdataY(
		BMC050_S16 *mdata_y);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_read_mdataZ(
		BMC050_S16 *mdata_z);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_mdataResistance(
		BMC050_U16  *mdata_resistance);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_read_register(
		unsigned char addr, unsigned char *data, unsigned char len);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_write_register(
		unsigned char addr, unsigned char *data, unsigned char len);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_self_test_X(
		unsigned char *self_testx);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_self_test_Y(
		unsigned char *self_testy);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_self_test_Z(
		unsigned char *self_testz);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_self_test_XYZ(
		unsigned char *self_testxyz);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_data_rdy_status(
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_init_trim_registers(void);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_status_reg(
		unsigned char *status_data);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_power_control_reg(
		unsigned char *pwr_cntl_data);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_soft_reset(void);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_spi3(
		unsigned char value);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_powermode(
		unsigned char *mode);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_powermode(
		unsigned char mode);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_adv_selftest(
		unsigned char adv_selftest);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_adv_selftest(
		unsigned char *adv_selftest);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_datarate(
		unsigned char data_rate);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_datarate(
		unsigned char *data_rate);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_functional_state(
		unsigned char functional_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_functional_state(
		unsigned char *functional_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_selftest(
		unsigned char selftest);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_selftest(
		unsigned char *selftest);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_perform_advanced_selftest(
		BMC050_S16 *diff_z);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_data_overrun_function(
		unsigned char data_overrun_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_data_overrun_function(
		unsigned char *data_overrun_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_data_overflow_function(
		unsigned char data_overflow);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_data_overflow_function(
		unsigned char *data_overflow);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_data_highthreshold_Z_function(
		unsigned char data_highthreshold_z_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_data_highthreshold_Z_function(
		unsigned char *data_highthreshold_z_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_data_highthreshold_Y_function(
		unsigned char data_highthreshold_y_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_data_highthreshold_Y_function(
		unsigned char *data_highthreshold_y_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_data_highthreshold_X_function(
		unsigned char data_highthreshold_x_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_data_highthreshold_X_function(
		unsigned char *data_highthreshold_x_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_data_lowthreshold_Z_function(
		unsigned char data_lowthreshold_z_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_data_lowthreshold_Z_function(
		unsigned char *data_lowthreshold_z_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_data_lowthreshold_Y_function(
		unsigned char data_lowthreshold_y_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_data_lowthreshold_Y_function(
		unsigned char *data_lowthreshold_y_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_data_lowthreshold_X_function(
		unsigned char data_lowthreshold_x_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_data_lowthreshold_X_function(
		unsigned char *data_lowthreshold_x_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_data_ready_function(
		unsigned char *data_ready_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_data_ready_function(
		unsigned char data_ready_function_state);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_interrupt_func(
		unsigned char *int_func);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_interrupt_func(
		unsigned char int_func);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_control_measurement_z(
		unsigned char *enable_disable);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_control_measurement_z(
		unsigned char enable_disable);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_control_measurement_y(
		unsigned char enable_disable);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_control_measurement_y(
		unsigned char *enable_disable);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_control_measurement_x(
		unsigned char enable_disable);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_control_measurement_x(
		unsigned char *enable_disable);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_DR_polarity(
		unsigned char dr_polarity_select);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_DR_polarity(
		unsigned char *dr_polarity_select);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_interrupt_latch(
		unsigned char interrupt_latch_select);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_interrupt_latch(
		unsigned char *interrupt_latch_select);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_intpin_polarity(
		unsigned char int_polarity_select);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_intpin_polarity(
		unsigned char *int_polarity_select);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_low_threshold(
		BMC050_S16 *low_threshold);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_low_threshold(
		BMC050_S16 low_threshold);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_high_threshold(
		BMC050_S16 *high_threshold);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_high_threshold(
		BMC050_S16 high_threshold);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_repetitions_XY(
		unsigned char *no_repetitions_xy);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_repetitions_XY(
		unsigned char no_repetitions_xy);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_repetitions_Z(
		unsigned char *no_repetitions_z);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_repetitions_Z(
		unsigned char no_repetitions_z);
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_presetmode(unsigned char *mode);

static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_presetmode(unsigned char mode);
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_init(struct bmc050 *bmc050)
{
	BMC050_RETURN_FUNCTION_TYPE comres = 0;
	unsigned char a_data_u8r[2];
	p_bmc050 = bmc050;

	p_bmc050->dev_addr = BMM050_I2C_ADDRESS;
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_datarate(unsigned char *data_rate)
{
	BMC050_RETURN_FUNCTION_TYPE comres = 0;
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_datarate(unsigned char data_rate)
{
	BMC050_RETURN_FUNCTION_TYPE comres = 0;
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_powermode(unsigned char *mode)
{
	BMC050_RETURN_FUNCTION_TYPE comres = 0;
	unsigned char v_data_u8r;
	if (p_bmc050 == BMC050_NULL) {
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_powermode(unsigned char mode)
{
	BMC050_RETURN_FUNCTION_TYPE comres = 0;
	unsigned char v_data_u8r;
	if (p_bmc050 == BMC050_NULL) {
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_raw_xyz(struct bmm050api_mdata *mdata)
{
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_read_mdataXYZ(struct bmm050api_mdata *mdata)
{
	BMC050_RETURN_FUNCTION_TYPE comres;
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_selftest(unsigned char selftest)
{
	BMC050_RETURN_FUNCTION_TYPE comres = 0;
	unsigned char v_data1_u8r;
	if (p_bmc050 == BMC050_NULL) {
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_set_adv_selftest(unsigned char adv_selftest)
{
	BMC050_RETURN_FUNCTION_TYPE comres = 0;
	unsigned char v_data1_u8r;
	if (p_bmc050 == BMC050_NULL) {
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_read_mdataZ(BMC050_S16 *mdata_z)
{
	BMC050_RETURN_FUNCTION_TYPE comres;
	BMC050_S16 raw_dataZ;
	BMC050_U16 raw_dataR;
...
static BMC050_RETURN_FUNCTION_TYPE bmm050api_get_halldataZ(BMC050_S16 *mdata_z)
{
	BMC050_RETURN_FUNCTION_TYPE comres;
	unsigned char a_data_u8r[2];
	if (p_bmc050 == BMC050_NULL) {
...
static struct i2c_board_info __initdata bmm050_i2c_info = {I2C_BOARD_INFO(BMM050_DEV_NAME, BMM050_I2C_ADDRESS)};
...
static ssize_t store_test_value(struct device_driver *ddri, char *buf, size_t count)
{
	...
	if (1 == data) {
		/* self test */
		err = bmm050api_set_functional_state(BMC050_SLEEP_MODE);
		mdelay(3);
