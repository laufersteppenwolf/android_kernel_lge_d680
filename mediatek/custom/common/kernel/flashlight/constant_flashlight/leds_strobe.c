...
Functions
*****************************************************************************/
//#define FLASH_MODE_PIN_EXIST
#if 1

#ifdef FLASH_MODE_PIN_EXIST
#define GPIO_CAMERA_FLASH_MODE GPIO85
...
//                                                  
    if(1/*BMT_status.temperature > (-15)*/) //                                                                     
    {
