...
#include <cust_eint.h>
/*                                                                                          */
/*                            TD228686, workaround : does not work rtc_bbpu_power_down() when power-off in connection with TA */
...
/*                                                                                          */
/*                            TD228686, workaround : does not work rtc_bbpu_power_down() when power-off in connection with TA */
    lge_save_boot_reason(LGE_BOOT_NORMAL_POWER_OFF, 0x0, 0x0);
/*                                                                                          */
	printk("mt_power_off\n");
