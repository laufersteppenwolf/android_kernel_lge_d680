...
#define CUST_EINT_ACCDET_SENSITIVE        CUST_EINT_EDGE_SENSITIVE
...
#define CUST_EINT_EOC_NUM              7
#define CUST_EINT_EOC_DEBOUNCE_CN      0
#define CUST_EINT_EOC_POLARITY         CUST_EINT_POLARITY_LOW
#define CUST_EINT_EOC_SENSITIVE        CUST_EINT_LEVEL_SENSITIVE
#define CUST_EINT_EOC_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
