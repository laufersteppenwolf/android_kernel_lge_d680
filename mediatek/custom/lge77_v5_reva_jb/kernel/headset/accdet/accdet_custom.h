...
#ifdef ACCDET_EINT
#define ACCDET_DELAY_ENABLE_TIME 10 //delay 500ms to enable accdet after EINT 
#define ACCDET_EINT_HIGH_ACTIVE //default low active if not define ACCDET_EINT_HIGH_ACTIVE
#endif
...
/*                                                                                                            */
struct headset_mode_settings cust_headset_settings = {
	0x1900, 0x1900, 1, 0x12c, 0x400, 0x400, 0x20
};
// original
//struct headset_mode_settings cust_headset_settings = {
