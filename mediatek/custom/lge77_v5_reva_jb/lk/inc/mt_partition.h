...
#define PART_BLKS_MISC2   BLK_NUM(PART_SIZE_MISC2)
...
#define PART_BLKS_PERSIST_LG   BLK_NUM(PART_SIZE_PERSIST_LG)
#define PART_BLKS_PERSIST   BLK_NUM(PART_SIZE_PERSIST)
#define PART_BLKS_MPT   BLK_NUM(PART_SIZE_MPT)
#define PART_BLKS_LGFOTA   BLK_NUM(PART_SIZE_LGFOTA)
#define PART_BLKS_SWAP   BLK_NUM(PART_SIZE_SWAP)
#define PART_BLKS_CUST   BLK_NUM(PART_SIZE_CUST)
#define PART_BLKS_RCT   BLK_NUM(PART_SIZE_RCT)
