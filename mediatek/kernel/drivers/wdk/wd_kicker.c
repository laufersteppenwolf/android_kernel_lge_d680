...
/*                                                                                                         */
#define LGE_USE_WDOG_SPINLOCK_IRQ
...
//                                                                            
#if 1 //CONFIG_MTK_AEE_FEATURE auto enable or disable WDT isr or hw mode
//                                                                            
...
/*                                                                                                */
#if defined(CONFIG_LGE_HANDLE_PANIC) && !defined(USER_BUILD_KERNEL)
				loc_wk_wdt->config(WK_WDT_EXT_TYPE, g_wk_wdt_mode, loc_timeout);
#else
