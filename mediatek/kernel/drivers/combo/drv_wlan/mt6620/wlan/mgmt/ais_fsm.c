...
**
** 11 15 2012 cp.wu
** [ALPS00382763] N820_JB:[WIFI]N820JB WLAN ±K???,«ÝÉó?¬y??¤j
...
/*#if CFG_ENABLE_WIFI_DIRECT
			...
			{
				prScanReqMsg->u2ChannelDwellTime = SCN_CHANNEL_DWELL_TIME_EXT_MSEC;//AIS_ROAMING_SCAN_CHANNEL_DWELL_TIME;
			}
			else
			{
				prScanReqMsg->u2ChannelDwellTime = 200;
			}
#endif*/
            if(prAisFsmInfo->u4ScanIELength > 0) {
