...
#define GSENSOR_IOCTL_SET_CALI                _IOW(GSENSOR, 0x07, SENSOR_DATA)
#define GSENSOR_IOCTL_GET_CALI                _IOW(GSENSOR, 0x08, SENSOR_DATA)
#define GSENSOR_IOCTL_CLR_CALI                _IO(GSENSOR, 0x09)
